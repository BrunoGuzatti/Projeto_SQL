...
insert into funcionarios (nome, cpf, data_nacimento, endereco, telefone, email, cargo, salario, data_admissao) value
...
insert into cliente (nome, cpf, data_nascimento, endereço, telefone, email, data_cadastro) value
...
insert into produtos (nome, descriao, preço, categoria) value
...
insert into info_produtos (id_produto, ingredientes, fornecedor) value
...
insert into pedidos (id_cliente, id_funcionario, id_produto, quantidade, data_pedido, status) value
